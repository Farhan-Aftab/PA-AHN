# ================================================================
# FILE 3: models/resnet18_pa_ahn_toggle.py
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes: int, planes: int, stride: int = 1, temperature: float = 0.7, use_prior_anchor: bool = True):
        super().__init__()
        ...
        if stride != 1 or in_planes != planes:
            self.shortcut = nn.Sequential(
                ...
                AdaptiveHybridNorm2d(planes, temperature=temperature, use_prior_anchor=use_prior_anchor),
            )
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes: int = 100, temperature: float = 0.7, use_prior_anchor: bool = True):
        super().__init__()
        self.in_planes = 64
...
def ResNet18_AHN(num_classes: int = 100, temperature: float = 0.7, use_prior_anchor: bool = True):
    return ResNet(BasicBlock, [2, 2, 2, 2], num_classes=num_classes, temperature=temperature, use_prior_anchor=use_prior_anchor)
